...
public class HttpUtil {
	...
	private static int http_connection_timeout = 15000;
	private static int http_so_timeout = 30000;
	private static boolean http_stale_check_enabled = true;
	private static boolean http_tcp_no_delay = true;
